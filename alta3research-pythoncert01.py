...
""" This code will show you the names and crafts of the astronauts currently in space. In addition, it will randomly select one of the astronauts and display his/her name. 
The code will also show you the top 10 NASA most recently updated NASA projects and, upon request, will also return the titles and benefits of selected project Id's """
...
#Print the number astronauts currently in space
